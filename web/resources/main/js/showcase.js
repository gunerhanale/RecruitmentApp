...
$(document).ready(function() {
    ...
    var Showcase = {
        ...
        mobileMenuBtnInner: $('#mobile-menu-btn-inner'),
        ...
        localStorage.setItem("activeSubMenuItem",$(submenuLink).attr("href"));
        }     
    ...
    Showcase.mobileMenuBtnInner.on('click', function(e) {
       Showcase.menu.toggleClass('active-menu'); 
       e.preventDefault();
    });    
...
function restoreMenuState() {
    ...
    $("a[href*='"+activeSubMenuItem+"']").removeClass("SubMenuLink").addClass("OpenSubMenuLink");    
    console.log($("a[href*='"+activeSubMenuItem+"']"));
